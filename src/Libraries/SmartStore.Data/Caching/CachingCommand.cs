...
namespace SmartStore.Data.Caching
{
    ...
    internal sealed class CachingCommand : DbCommand
    {
        ...
        internal CommandTreeFacts CommandTreeFacts => _commandTreeFacts;

        internal CacheTransactionInterceptor CacheTransactionInterceptor => _cacheTransactionInterceptor;

        internal DbCachingPolicy CachingPolicy => _policy;

        internal DbCommand WrappedCommand => _command;

        private bool IsCacheable => _commandTreeFacts.IsQuery &&
        ...
        private bool IsQueryCached => SingletonQueries.Current.IsQueryCached(_commandTreeFacts.MetadataWorkspace, CommandText);
