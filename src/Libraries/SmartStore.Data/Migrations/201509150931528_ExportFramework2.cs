	...
	public partial class ExportFramework2 : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.Delete(
				...
				//"Plugins.Feed.Froogle.ShippingCost",
				//"Plugins.Feed.Froogle.ShippingCost.Hint",
				//"Plugins.Feed.Froogle.ShippingTime",
				//"Plugins.Feed.Froogle.ShippingTime.Hint",
				...
				//"Plugins.Feed.Froogle.ExportFormat",
				//"Plugins.Feed.Froogle.ExportFormat.Hint",
