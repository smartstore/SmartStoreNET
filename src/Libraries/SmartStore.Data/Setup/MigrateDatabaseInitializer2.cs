...
namespace SmartStore.Data.Setup
{
	...
	/// </summary>
	public class MigrateDatabaseInitializer2<TContext, TConfig> : IDatabaseInitializer<TContext> 
		...
		where TConfig : DbMigrationsConfiguration<TContext>, new()
	{
		...
		public MigrateDatabaseInitializer2()
			: this(null, null, null)
		{
		}

		public MigrateDatabaseInitializer2(string connectionString)
			: this(connectionString, null, null)
		{
		}

		public MigrateDatabaseInitializer2(string[] sqlFiles)
			: this(null, null, sqlFiles)
		{
		}

		public MigrateDatabaseInitializer2(string[] tablesToCheck, string[] sqlFiles)
			: this(null, tablesToCheck, sqlFiles)
		{
		}

		public MigrateDatabaseInitializer2(string connectionString, string[] tablesToCheck, string[] sqlFiles)
		{
