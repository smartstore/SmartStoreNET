...
namespace SmartStore.Data.Setup
{
    public abstract class InvariantSeedData
    {
        ...
        {
            get { return "Vestuário e Calçados"; }
        }
        ...
        {
            get { return "Eletrônicos e Software"; }
        }

        protected virtual string TaxNameTaxFree
        {
            get { return "Livre de impostos"; }
        }
                ...
                new ShippingMethod
                    {
                        ...
                        Description ="Pegar seus itens na loja",
                        DisplayOrder = 0
                    },
                new ShippingMethod
                    {
                        Name = "By Ground",
                        Description ="Em comparação com outros métodos de envio, como por voo ou mais de mares, envio de terreno é realizada mais perto da terra",
                        DisplayOrder = 1
                    },
            };
            this.Alter(entities);
        ...
        public Address AdminAddress()
        {
            var cCountry = _ctx.Set<Country>()
                .Where(x => x.ThreeLetterIsoCode == "BRA")
                .FirstOrDefault();
            ...
            var entity = new Address()
            {
                ...
                FaxNumber = "",
                Company = "João da Silva LTDA",
                Address1 = "Getúlio Vargas, 45",
                Address2 = "",
                City = "São Paulo",
                StateProvince = cCountry.StateProvinces.FirstOrDefault(),
                Country = cCountry,
                ZipPostalCode = "058000000",
                ...
                new Topic
                    {
                        ...
                        Title = "Sobre nós",
                        Body = "<p>Coloque as informações do seu &quot;Sobre nós&quot; aqui. Você consegue editar pelo painel administrativo.</p>"
                    },
                new Topic
                    {
										  ...
										  new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Adicionar uma nova categoria"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewCheckoutAttribute",
                                                  Enabled = true,
                                                  Name = "Adicionar um novo atributo de checkout"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Adicionar um novo papel cliente"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewDiscount",
                                                  Enabled = true,
                                                  Name = "Adicionar um novo desconto"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewGiftCard",
                                                  Enabled = true,
                                                  Name = "Adicionar um novo cartão de presente"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewManufacturer",
                                                  Enabled = true,
                                                  Name = "Adicionar um novo fabricante"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Adicionar um novo atributo do produto"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewSetting",
                                                  Enabled = true,
                                                  Name = "Adicionar uma nova configuração"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewSpecAttribute",
                                                  Enabled = true,
                                                  Name = "Adicionar um novo atributo especificação"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "AddNewWidget",
                                                  Enabled = true,
                                                  Name = "Adicionar um novo widget"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Excluir um atributo de check-out"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Excluir uma função cliente"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteDiscount",
                                                  Enabled = true,
                                                  Name = "Excluir um desconto"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteGiftCard",
                                                  Enabled = true,
                                                  Name = "Excluir um cartão de presente"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteManufacturer",
                                                  Enabled = true,
                                                  Name = "Excluir um fabricante"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Excluir um atributo do produto"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteReturnRequest",
                                                  Enabled = true,
                                                  Name = "Excluir um pedido de devolução"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteSetting",
                                                  Enabled = true,
                                                  Name = "Excluir uma configuração"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteSpecAttribute",
                                                  Enabled = true,
                                                  Name = "Excluir um atributo especificação"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "DeleteWidget",
                                                  Enabled = true,
                                                  Name = "Excluir um widget"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Editar um atributo check-out"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Editar um papel cliente"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditDiscount",
                                                  Enabled = true,
                                                  Name = "Editar um desconto"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditGiftCard",
                                                  Enabled = true,
                                                  Name = "Editar um cartão de presente"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditManufacturer",
                                                  Enabled = true,
                                                  Name = "Editar um fabricante"
                                              },
                                          new ActivityLogType
                                              {
                                          ...
                                          new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = true,
                                                  Name = "Editar um atributo do produto"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditPromotionProviders",
                                                  Enabled = true,
                                                  Name = "Editar prestadores de promoção"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditReturnRequest",
                                                  Enabled = true,
                                                  Name = "Editar um pedido de devolução"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditSettings",
                                                  Enabled = true,
                                                  Name = "Editar configuração (ões)"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditSpecAttribute",
                                                  Enabled = true,
                                                  Name = "Editar um atributo especificação"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditWidget",
                                                  Enabled = true,
                                                  Name = "Editar um widget"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "EditThemeVars",
                                                  Enabled = true,
                                                  Name = "Editar variáveis do tema"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "ResetThemeVars",
                                                  Enabled = true,
                                                  Name = "Redefinição de variáveis do tema para o padrão"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "ImportThemeVars",
                                                  Enabled = true,
                                                  Name = "Importar variáveis do tema"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "ExportThemeVars",
                                                  Enabled = true,
                                                  Name = "Exportar variáveis do tema"
                                              },
										  ...
										  new ActivityLogType
                                              {
                                                  ...
                                                  Enabled = false,
                                                  Name = "Loja pública. Ver uma categoria"
                                              },
                                          new ActivityLogType
                                              {
            ...
            var entities = new List<CategoryTemplate>
                               {
                                   new CategoryTemplate
                                       {
                                           Name = "Produtos em grade ou linhas",
            ...
            var entities = new List<ManufacturerTemplate>
                               {
                                   new ManufacturerTemplate
                                       {
                                           Name = "Produtos em grades ou linhas",
        ...
        public IList<BlogPost> BlogPosts()
        {
            ...
            var blogPostDiscountCoupon = new BlogPost()
            {
                ...
                Title = "Cupons de desconto on-line",
            ...
            var blogPostCustomerService = new BlogPost()
            {
                AllowComments = true,
                Language = defaultLanguage,
                Title = "Atendimento ao Cliente - Serviço ao Cliente",
                ...
                Tags = "e-commerce, ThinkStore.NET, asp.net, sample tag, money",
        ...
        public IList<NewsItem> NewsItems()
        {
            ...
            var news1 = new NewsItem()
            {
                AllowComments = true,
                Language = defaultLanguage,
                Title = "ThinkStore.NET novo lançamento!",
                Short = "ThinkStore.NET includes everything you need to begin your e-commerce online store.",
                Full = "<p>ThinkStore.NET includes everything you need to begin your e-commerce online store.<br/>  We have thought of everything and it's all included!<br/><br/ThinkStore.NET is a fully customizable shop-system. It's stable and highly usable.<br>  From downloads to documentation, www.ThinkStore.com offers a comprehensive base of information, resources, and support to the ThinkStore.NET community.</p>",
                Published = true,
                MetaTitle = "ThinkStore.NET new release!",
            ...
            var news2 = new NewsItem()
            {
                AllowComments = true,
                Language = defaultLanguage,
                Title = "Nova loja online está aberta!",
                Short = "The new ThinkStore.NET store is open now!  We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site, this will enable you to keep up to date with any new products.",
        ...
        public IList<Poll> Polls()
        {
            ...
            {
                Language = defaultLanguage,
                Name = "Com que frequência compra online?",
                SystemKeyword = "RightColumnPoll",
                Published = true,
                DisplayOrder = 2,
            };
