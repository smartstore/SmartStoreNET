            ...
            foreach (var product in products)
            {
                ...
                if (productVariants != null)
                {
                    foreach (var productVariant in productVariants)
                    {
                        ...
                        if (productVariant.DeliveryTimeId.HasValue)
                            xmlWriter.WriteElementString("DeliveryTimeId", null, productVariant.DeliveryTimeId.Value.ToString());
						...
						// codehint: sm-add
						xmlWriter.WriteElementString("BasePrice_Enabled", null, productVariant.BasePrice.Enabled.ToString());
						xmlWriter.WriteElementString("BasePrice_MeasureUnit", null, productVariant.BasePrice.MeasureUnit);
						if (productVariant.BasePrice.Amount.HasValue)
							xmlWriter.WriteElementString("BasePrice_Amount", null, productVariant.BasePrice.Amount.Value.ToString());
						if (productVariant.BasePrice.BaseAmount.HasValue)
							xmlWriter.WriteElementString("BasePrice_BaseAmount", null, productVariant.BasePrice.BaseAmount.Value.ToString());
                        ...
                        // codehint: sm-add (ProductVariantAttributeCombinations)
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var p in products)
                {
                    ...
                    foreach (var pv in productVariants)
                    {
						...
						// codehint: sm-add
						worksheet.Cells[row, col].Value = pv.DeliveryTimeId;
						col++;
						worksheet.Cells[row, col].Value = pv.BasePrice.Enabled;
						col++;
						worksheet.Cells[row, col].Value = pv.BasePrice.MeasureUnit;
						col++;
						worksheet.Cells[row, col].Value = pv.BasePrice.Amount;
						col++;
						worksheet.Cells[row, col].Value = pv.BasePrice.BaseAmount;
						col++;
