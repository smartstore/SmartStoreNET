...
openid = {
	...
	useInputBox : function(provider) {
		...
		html += '<div class="input-append"><input id="' + id + '" type="text" style="' + style + '" name="' + id + '" value="' + value + '" />'
              + '<button class="primaryAction btn btn-primary" type="submit">' + this.signin_text + '</button></div>'
