...
namespace SmartStore.Admin.Controllers
{
    ...
    public partial class CategoryController : AdminControllerBase
    {
        ...
        protected void PrepareCategoryModel(CategoryModel model, Category category)
        {
            ...
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "0", Text =T("Common.Secondary"), Selected = model.BadgeStyle == 0 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "1", Text = T("Common.Primary"), Selected = model.BadgeStyle == 1 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "2", Text = T("Common.Success"), Selected = model.BadgeStyle == 2 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "3", Text = T("Common.Info"), Selected = model.BadgeStyle == 3 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "4", Text = T("Common.Warning"), Selected = model.BadgeStyle == 4 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "5", Text = T("Common.Danger"), Selected = model.BadgeStyle == 5 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "6", Text = T("Common.Light"), Selected = model.BadgeStyle == 6 });
            model.AvailableBadgeStyles.Add(new SelectListItem { Value = "7", Text = T("Common.Dark"), Selected = model.BadgeStyle == 7 });
        }
