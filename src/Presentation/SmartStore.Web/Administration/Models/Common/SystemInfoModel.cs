...
namespace SmartStore.Admin.Models.Common
{
    public class SystemInfoModel : ModelBase
    {
        ...
        public string DatabaseSizeString => (DatabaseSize == 0 ? "" : Prettifier.BytesToString(DatabaseSize));

        [SmartResourceDisplayName("Admin.System.SystemInfo.UsedMemorySize")]
        public long UsedMemorySize { get; set; }
        public string UsedMemorySizeString => Prettifier.BytesToString(UsedMemorySize);
