	...
	$.extend($.summernote.plugins, {
		'imageAttributes': function (context) {
			...
			context.memo('button.imageAttributes', function () {
				var button = ui.button({
					...
					callback: function (btn) {
						...
						btn.attr("title", lang.imageAttributes.tooltip);
						btn.tooltip();
					},
					click: function () {
			...
			this.initialize = function () {
				...
				var body = '<ul class="nav note-nav nav nav-tabs nav-tabs-line note-nav-tabs">' +
				...
				body += '</ul>' +
					...
					'    <div class="note-form-group form-group row note-group-imageAttributes-class">' +
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.class + '</label>' +
					...
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-style">' +
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.style + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-style form-control note-form-control note-input" type="text">' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-role">' +
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.role + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					...
					'    <div class="note-form-group form-group row note-group-imageAttributes-link-href">' +
					'      <label class="col-form-label note-form-label col-3">' + lang.imageAttributes.linkHref + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-link-href form-control note-form-control note-input" type="text">' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-link-target">' +
					'      <label class="col-form-label note-form-label col-3">' + lang.imageAttributes.linkTarget + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-link-target form-control note-form-control note-input" type="text">' +
					'		 <small class="form-text text-muted note-help-block">' + lang.imageAttributes.linkTargetInfo + '</small>' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-link-class">' +
					'      <label class="col-form-label note-form-label col-3">' + lang.imageAttributes.linkClass + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-link-class form-control note-form-control note-input" type="text">' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-link-style">' +
					'      <label class="col-form-label note-form-label col-3">' + lang.imageAttributes.linkStyle + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-link-style form-control note-form-control note-input" type="text">' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-link-rel">' +
					'      <label class="col-form-label note-form-label col-3">' + lang.imageAttributes.linkRel + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-link-rel form-control note-form-control note-input" type="text">' +
					'        <small class="form-text text-muted note-help-block">' + lang.imageAttributes.linkRelInfo + '</small>' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-link-role">' +
					'      <label class="col-form-label note-form-label col-3">' + lang.imageAttributes.linkRole + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
				...
				body += '  <div class="tab-pane note-tab-pane fade show active" id="note-imageAttributes' + timestamp + '">' +
					...
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.src + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					...
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-title">' +
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.title + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-title form-control note-form-control note-input" type="text" />' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-alt">' +
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.alt + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
					'        <input class="note-imageAttributes-alt form-control note-form-control note-input" type="text" />' +
					'      </div>' +
					'    </div>' +
					'    <div class="note-form-group form-group row note-group-imageAttributes-dimensions">' +
					'      <label class="col-form-label note-form-label col-sm-3">' + lang.imageAttributes.dimensions + '</label>' +
					'      <div class="input-group note-input-group col-12 col-sm-9">' +
