...
hi_btnhov:"ui-state-hover",hi_hnd:"ui-icon ui-icon-grip-dotted-horizontal"},bootstrap:{container:"alert",notice:"",notice_icon:"fa fa-exclamation-circle",info:"alert-info",info_icon:"fa fa-info-circle",success:"alert-success",success_icon:"fa fa-check-circle",error:"alert-error",error_icon:"fa fa-exclamation-triangle",closer:"fa fa-times",pin_up:"fa fa-pause",pin_down:"fa fa-play",hi_menu:"well",hi_btn:"btn",hi_btnhov:"",hi_hnd:"fa fa-chevron-down"}},s=function(){r=d("body");i=d(window);i.bind("resize",function(){j&&clearTimeout(j);
