...
namespace SmartStore.Services.Tests.Customers
{
	...
	class WalletServiceTests : ServiceTest
	{
		...
		public void Can_add_wallet_history_entry()
		{
			...
			var entry1 = customer.AddWalletHistoryEntry(120M, WalletUsageReason.None, storeId);
			entry1.AmountBalance.ShouldEqual(120M);

			var entry2 = customer.AddWalletHistoryEntry(60.5M, WalletUsageReason.None, 2);
			entry2.AmountBalance.ShouldEqual(60.5M);

			var entry3 = customer.AddWalletHistoryEntry(60.5M, WalletUsageReason.None, storeId);
			entry3.AmountBalance.ShouldEqual(180.5M);

			var entry4 = customer.AddWalletHistoryEntry(-20M, WalletUsageReason.None, storeId, order);
